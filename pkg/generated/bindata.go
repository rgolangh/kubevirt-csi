...
var _deploySanityTestYaml = []byte(`kind: Pod
apiVersion: v1
metadata:
  name: sanity-test
  namespace: kubevirt-csi-driver
...
func deploySanityTestYamlBytes() ([]byte, error) {
	return _deploySanityTestYaml, nil
}

func deploySanityTestYaml() (*asset, error) {
	bytes, err := deploySanityTestYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "deploy/sanity-test.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"deploy/sanity-test.yaml":                     deploySanityTestYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"deploy": {nil, map[string]*bintree{
		...
		"sanity-test.yaml":                   {deploySanityTestYaml, map[string]*bintree{}},
